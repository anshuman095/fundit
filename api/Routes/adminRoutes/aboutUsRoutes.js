...
import { createUpdateAboutUs, getAboutUs } from "../../Controller/aboutUsController.js";
import { validate } from "../../helper/general.js";
import { aboutUsSchema } from "../../helper/validations.js";

const aboutUsRoutes = Router();

// /**
//  * @swagger
//  * /api/aboutUs/create-update-about-us:
//  *   post:
...
aboutUsRoutes.post("/create-update-about-us", createUpdateAboutUs);
