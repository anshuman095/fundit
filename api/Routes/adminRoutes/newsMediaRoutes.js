...
import { createUpdateNewsMedia, getNewsMedia } from "../../Controller/newsMediaController.js";
import { validate } from "../../helper/general.js";
// import { NewsMediaSchema } from "../../helper/validations.js";

const newsMediaRoutes = Router();

// /**
//  * @swagger
//  * /api/NewsMedia/create-update-about-us:
//  *   post:
...
newsMediaRoutes.post("/create-update-news-media", createUpdateNewsMedia);

// /**
//  * @swagger
//  * /api/NewsMedia/get-about-us:
//  *   get:
 ...
 */
newsMediaRoutes.get("/get-news-media/:id?", getNewsMedia);

export default newsMediaRoutes;
