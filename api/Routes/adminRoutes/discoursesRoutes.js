...
import { createUpdateDiscourses, getDiscourses } from "../../Controller/discoursesController.js";
import { validate } from "../../helper/general.js";
// import { DiscoursesSchema } from "../../helper/validations.js";

const discoursesRoutes = Router();

// /**
//  * @swagger
//  * /api/Discourses/create-update-about-us:
//  *   post:
...
discoursesRoutes.post("/create-update-discourses", createUpdateDiscourses);

// /**
//  * @swagger
//  * /api/Discourses/get-about-us:
//  *   get:
 ...
 */
discoursesRoutes.get("/get-discourses/:id?", getDiscourses);

export default discoursesRoutes;
