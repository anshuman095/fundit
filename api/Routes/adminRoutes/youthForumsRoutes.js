...
import { createUpdateYouthForums, getYouthForums } from "../../Controller/youthForumsController.js";
import { validate } from "../../helper/general.js";
// import { YouthForumsSchema } from "../../helper/validations.js";

const youthForumsRoutes = Router();

// /**
//  * @swagger
//  * /api/YouthForums/create-update-about-us:
//  *   post:
...
youthForumsRoutes.post("/create-update-youth-forums", createUpdateYouthForums);

// /**
//  * @swagger
//  * /api/YouthForums/get-about-us:
//  *   get:
 ...
 */
youthForumsRoutes.get("/get-youth-forums/:id?", getYouthForums);

export default youthForumsRoutes;
