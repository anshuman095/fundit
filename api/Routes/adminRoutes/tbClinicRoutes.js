...
import { createUpdateTbClinic, getTbClinic } from "../../Controller/tbClinicController.js";
import { validate } from "../../helper/general.js";
// import { TbClinicSchema } from "../../helper/validations.js";

const tbClinicRoutes = Router();

// /**
//  * @swagger
//  * /api/TbClinic/create-update-about-us:
//  *   post:
...
tbClinicRoutes.post("/create-update-tb-clinic", createUpdateTbClinic);

// /**
//  * @swagger
//  * /api/TbClinic/get-about-us:
//  *   get:
 ...
 */
tbClinicRoutes.get("/get-tb-clinic/:id?", getTbClinic);

export default tbClinicRoutes;
