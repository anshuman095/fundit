...
import { createUpdateVolunteer, getVolunteer } from "../../Controller/volunteerController.js";
import { validate } from "../../helper/general.js";
// import { VolunteerSchema } from "../../helper/validations.js";

const volunteerRoutes = Router();

// /**
//  * @swagger
//  * /api/Volunteer/create-update-about-us:
//  *   post:
...
volunteerRoutes.post("/create-update-volunteer", createUpdateVolunteer);

// /**
//  * @swagger
//  * /api/Volunteer/get-about-us:
//  *   get:
 ...
 */
volunteerRoutes.get("/get-volunteer/:id?", getVolunteer);
