...
import { createUpdateMedicalCenter, getMedicalCenter } from "../../Controller/medicalCenterController.js";
import { validate } from "../../helper/general.js";
// import { MedicalCenterSchema } from "../../helper/validations.js";

const medicalCenterRoutes = Router();

// /**
//  * @swagger
//  * /api/MedicalCenter/create-update-about-us:
//  *   post:
...
medicalCenterRoutes.post("/create-update-medical-center", createUpdateMedicalCenter);

// /**
//  * @swagger
//  * /api/MedicalCenter/get-about-us:
//  *   get:
 ...
 */
medicalCenterRoutes.get("/get-medical-center/:id?", getMedicalCenter);

export default medicalCenterRoutes;
